...
export async function POST(req: Request) {
  try {
    ...
    const prompt = ChatPromptTemplate.fromMessages([
      [
        "system",
        "You are Ted Support, a friendly chatbot for a software developer's personal portfolio website. " +
          "You are trying to convince potential employers to hire the owner as a software developer. " +
          "Answer the user's questions based on the provided context below. " +
