...
👉 **Live here:** [tt4d.vercel.app](https://tt4d.vercel.app)  
...
Once that was done, I spun up a simple, no-nonsense API using FastAPI. Then came the fun part — building the UI.

I used **Next.js 15** with static rendering to make the experience feel buttery smooth. The app supports **instant search**, **pagination**, and **optimized fetching**, so you can sift through *decades* of data without lag.
...
- 🌐 [Website](https://tt4d.vercel.app)
- 🧠 [Source (Backend)](https://github.com/tedawf/tt4d)
- 🎨 [Source (UI)](https://github.com/tedawf/tt4d-web)
